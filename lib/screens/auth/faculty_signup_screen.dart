...
//  Sigup screen to create an id for faculty
class FacultySignUpScreen extends StatelessWidget {
  static const routeName = "/faculty_signup_screen";
  @override
...
class FacultySignupAuthCard extends StatefulWidget {
  const FacultySignupAuthCard({
    Key key,
  }) : super(key: key);

  @override
  _FacultySignupAuthCardState createState() => _FacultySignupAuthCardState();
}

class _FacultySignupAuthCardState extends State<FacultySignupAuthCard> {
  ...
  Future<void> _submit() async {
    ...
    final signUpResult = await context
        .read<AuthProvider>()
        .signUpWithEmailAndPassword(_authData, context, false);
