 ...
 String myUrl = "";
    ...
    var pickedTime = await showTimePicker(
      ...
      if(pickedTime!=null){
        ...
        setState(() {
          ...
          deadline = currentDate.toString().substring(0,10)+ " " + currentTime.toString().substring(10,15);
  ...
  if(isValid){
    ...
    if(deadline=="Select Deadline"){
      ...
      Provider.of<AssignmentProvider>(context,listen : false).uploadAssignment(subject,_assignment,asset, fileName);
