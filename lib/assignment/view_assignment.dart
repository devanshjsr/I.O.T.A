...
class _ViewAssignmentState extends State<ViewAssignment> {
  ...
  try{
    ...
    print('file path ================================== ${file.readAsBytesSync()}');
  ...
  Widget build(BuildContext context) {
    ...
    AssignmentArgument assignmentArgument = ModalRoute.of(context).settings.arguments;
        ...
        final DateTime currentTime = DateTime.utc(current.year,current.month,current.day,current.hour,current.minute);
        final DateTime assignmentTime = DateTime.utc(int.parse(year),int.parse(month),int.parse(day),int.parse(hr),int.parse(min));
  ...
  Future submitAssignment() async{
    ...
    List<int> asset = [];
      if(file!=null){
        ...
        await Provider.of<AssignmentProvider>(context,listen: false).uploadAssignmentWork(asset, assignmentArgument.assignment,fileName);
  ...
  Future<void> _selectTime() async{
    ...
    var pickedTime = await showTimePicker(
      ...
      if(pickedTime!=null){
        ...
        DateTime pickedDateTime = DateTime.utc(currentDate.year ,currentDate.month,currentDate.day,pickedTime.hour,pickedTime.minute);

        setState(() {
          deadline  = true;
        });
        await Provider.of<AssignmentProvider>(context,listen: false).changeDeadline(assignmentArgument.assignment,pickedDateTime.toIso8601String());
  ...
  Future<void> _selectDate() async{
    ...
    currentDate = DateTime(assignmentTime.year,assignmentTime.month,assignmentTime.day);
    print(currentDate);
  ...
  Future _deleteWork() async{
    ...
    await Provider.of<AssignmentProvider>(context,listen: false).deleteUploadedAssignment(assignmentArgument.assignment);
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              SizedBox(
                ...
                assignmentArgument.assignment.url.isEmpty ?  SizedBox(
                height : 20,
                ) : Container(
                child: 
                Column(
                ...
                trailing: GestureDetector(
                  ...
                  onTapDown : (data ){
                    CustomDialog.showDownloadDialog(context, data.globalPosition, assignmentArgument.assignment.url);
                  },
                  child: Icon(
              ...
              Row(           
                ...
                trailing: GestureDetector(
                  ...
                  onTapDown : (data ){
                    _getMyWorkUrl();
                    CustomDialog.showDownloadDialog(context, data.globalPosition, mySubmittedUrl);
                  },
                  child: Icon(
                  Icons.more_vert_rounded,
                  size: 35,
              ...
              ElevatedButton(
                ...
                onPressed:(){
                  assignmentArgument.type == "Pending" ?
                  submitAssignment() : _deleteWork();
                }, 
                child: Text(
                assignmentArgument.type == "Pending" ?
                DataModel.SUBMIT : "Undo Submission ",
